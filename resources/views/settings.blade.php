                                    ...
                                    <table id="example" class="table table-sm  table-nowrap card-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <a class="text-muted" href="#">Multiplier 1</a>
                                                </th>
                                                <th>
                                                    <a class="text-muted">Multiplier 2</a>
                                                </th>
                                                <th></th>
                                            </tr>
                                        </thead>
                                        <tbody class="list font-size-base">
                                            @foreach ($settings as $key => $setting)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span>{{ $setting->multiplier1 }}</span>
                                                    </td>
                                                    <td>
                                                        <span>{{ $setting->multiplier2 }}</span>
                                                    </td>
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered editMembers"
                                                            ...
                                                            <div class="modal-content editMembers">
                                                                ...
                                                                <div class="card-body editMembers">
                                                                    <form action="{{ url('edit-settings', $setting->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        <div class="row g-3">
                            ...
                            <div class="modal fade " id="modalAdd" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered editMembers" role="document">
                                    <div class="modal-content editMembers">
                                        ...
                                        <div class="card-body editMembers">
                                            <form action="{{ url('add-settings') }}" method="POST">
                                                @csrf
                                                <div class="row g-3">
                                                    <div class="col-12 col-md-6 mb-3">
                                                        <label class="form-label">Multiplier
                                                            1</label>
                                                        <input type="text" class="form-control" name="multiplier1">

                                                    </div>
                                                    <div class="col-12 col-md-6 mb-3">
                                                        <label class="form-label">Multiplier
                                                            2</label>
                                                        <input type="text" class="form-control" name="multiplier2">
